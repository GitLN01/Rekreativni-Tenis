...
<div class="container" style="background-image: url('./images/image11.jpg'); background-repeat:no-repeat; background-size:cover; background-position:center;">
        <div class="row" style="height: 68px; background-color:#6386a3">
            ...
            <div class="row">
                <div class="col-md-6">
                    ...
                    <!--ODJAVA IZ SESIJE-->
                <div class="col-md-6"  style="border:none;outline:none">
