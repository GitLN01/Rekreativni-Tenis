              ...
              <form id="formaReg" action="../controller-igraci/RegistracijaIgraci.php?action=insert" method="post">
                ...
                <div class="row">
                  <div class="col-md-6 mb-4">
                    ...
                    <div class="form-outline">
                      <input type="text" id="ime" name="ime" class="form-control form-control-lg" style="background-color: rgba(255, 255, 255, 0.5); border:none"/>
                  ...
                  <div class="col-md-6 mb-4">
                    ...
                    <div class="form-outline">
                      <input type="text" id="prezime" name="prezime" class="form-control form-control-lg" style="background-color: rgba(255, 255, 255, 0.5); border:none"/>
                ...
                <div class="row">
                  <div class="col-md-6 mb-3 d-flex align-items-center">
                    ...
                    <div class="form-outline w-100">
                      <input type="text" name="visina" class="form-control form-control-lg" id="visina" style="background-color: rgba(255, 255, 255, 0.5); border:none"/>
                  ...
                  <div class="col-md-6 mb-3 d-flex align-items-center">
                    ...
                    <div class="form-outline  w-100">
                      <input type="text" name="godine" class="form-control form-control-lg" id="godine" style="background-color: rgba(255, 255, 255, 0.5); border:none"/>
                  ...
                  <div class="col-md-6 mb-4" style="padding-left:15px">
                    ...
                    <div class="form-check form-check-inline">
                      <input class="form-check-input" type="radio" name="inlineRadioOptions" id="zenski" value="option1" checked style="background-color: rgba(255, 255, 255, 0.5); border:none"/>
                      <label class="form-check-label" for="zenski">Zenski</label>
                    </div>

                    <div class="form-check form-check-inline">
                      <input class="form-check-input" type="radio" name="inlineRadioOptions" id="muski" value="option2" style="background-color: rgba(255, 255, 255, 0.5); border:none"/>
                ...
                <div class="row">
                  <div class="col-md-6 mb-4 pb-2">
                    ...
                    <div class="form-outline">
                      <input type="email" name="email" id="email" class="form-control form-control-lg" placeholder="someone@example.com" style="background-color: rgba(255, 255, 255, 0.5); border:none"/>
                  ...
                  <div class="col-md-6 mb-4 pb-2">
                    ...
                    <div class="form-outline">
                      <input type="password" name="lozinka" id="lozinka" class="form-control form-control-lg" style="background-color: rgba(255, 255, 255, 0.5); border:none"/>
                  ...
                  <div class="row">
                    <div class="col-12">
                      ...
                      <select class="select form-control-lg" name="nazivkluba" style="background-color: rgba(255, 255, 255, 0.5); border:none">
                  ...
                  <div class="mt-4 pt-2 justify-content-center" style="text-align: center;">
                    <input class="btn btn-primary btn-lg" type="submit" name="action" value="Potvrdi" style="background-color: rgba(0, 0, 255, 0.5); border:none"/>
                  </div>
