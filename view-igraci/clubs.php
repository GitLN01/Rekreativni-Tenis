...
<div class="container">
  ...
  <div class="carousel-inner">
    ...
    <h5 style="color: green;">Zvezda</h5>
      <img src="./images/klub3.jpg" class="d-block w-50 h-50" alt="Zvezda">    
    </div>
    <div class="carousel-item ">
    <h5 style="color: green;">Partizan</h5>
      <img src="./images/klub2.jpg" class="d-block w-50" alt="...">
    </div>
    <div class="carousel-item ">
    <h5 style="color: green;">Napredak</h5>
      <img src="./images/klub1.jpg" class="d-block w-50" alt="...">
