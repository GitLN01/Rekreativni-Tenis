      ...
      <div class="row mt-4" style="width: 40%;margin-left:auto;margin-right:auto">
        <div class="col-md-12">
          <form id="formTeren" action="../controller-admin/Tereni.php?action=insert" method="post" class="border rounded p-5">
            <div class="mb-3">
              <label for="naziv" class="form-label">Naziv Terena <span class="text-danger">*</span></label>
              <input type="text" class="form-control" id="" name="naziv" value="<?= $teren->getNaziv() ?>">

            </div>
            <div class="mb-3">
              <label for="lokacija" class="form-label">Lokacija Terena <span class="text-danger">*</span></label>
              <input type="text" class="form-control" id="" name="lokacija" value="<?= $teren->getLokacija() ?>">
            </div>

            <div class="mb-3">
              <label for="kapacitet" class="form-label">Kapacitet Terena <span class="text-danger">*</span></label>
