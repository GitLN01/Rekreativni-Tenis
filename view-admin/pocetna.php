...
?>
        ...
        <div class="container" style="background-color:#ffffff;">
                ...
                <div id="carouselExampleCaptions" class="carousel slide" data-bs-ride="false" style="padding: 1.4rem;">
                    <div class="carousel-inner">
                        <div class="carousel-item active">
                            <img src="./images/image11.jpg" class="d-block" alt="" style="margin:auto; width:100%; height:90%">
                        </div>
                        <div class="carousel-item">
                            <img src="./images/image22.jpg" class="d-block" alt="" style="margin:auto; width:100%; height:90%">
                        </div>
                        <div class="carousel-item">
                            <img src="./images/image33.jpg" class="d-block" alt="" style="margin:auto; width:100%; height:90%">
                        </div>
                        <div class="carousel-item">
                            <img src="./images/image44.jpg" class="d-block" alt="" style="margin:auto; width:100%; height:90%">
                        </div>
                        <div class="carousel-item">
                            <img src="./images/image55.jpg" class="d-block" alt="" style="margin:auto; width:100%; height:90%">
                        </div>
                    </div>
            ...
            <script>
                ...
                setTimeout(showSlides, 2500); // Promena slike svake dve i po sekunde
                }
            </script>
