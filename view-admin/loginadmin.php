...
<head>
    ...
    <style>
        body {
            background-image: url('images/djokovic.jpg');
                        ...
                        <div class="card-body p-5 text-center">
                            ...
                            <form id="formLogin" action="../controller-admin/Login.php?action=login" method="post">
                                <div class="form-outline mb-4">
                                    ...
                                    <input type="text" id="korisnickoime" name="email" class="form-control form-control-lg"  style="border-radius: 1rem; background-color: rgba(255, 255, 255, 0.5);" />

                                </div>

                                <div class="form-outline mb-4">
                                    <label class="form-label" for="">Lozinka <span class="text-danger">*</span></label>
                                    <input type="password" id="lozinka" name="lozinka" class="form-control form-control-lg" style="border-radius: 1rem; background-color: rgba(255, 255, 255, 0.5);"/>

                                </div>

                                <input class="btn btn-primary btn-lg btn-block w-50" type="submit" value="Prijava" name="prijavi" style="border-radius: 1rem; background-color: rgba(0, 0, 255, 0.5);">
