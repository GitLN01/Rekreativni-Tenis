...
class RezervacijaController
{
    ...
    public function InsertRezervacijeDouble()
    {
        if ($_SERVER['REQUEST_METHOD'] == 'POST') {
            ...
            if (!empty($id_igraca2) && !empty($id_igraca3) && !empty($id_igraca4) && !empty($id_terena) && !empty($id_meca) && !empty($datum) && !empty($vreme)) {
    ...
    public function InsertRezervacijeSingle()
    {
        if ($_SERVER['REQUEST_METHOD'] == 'POST') {
            ...
            if (!empty($id_igraca2)  && !empty($id_terena) && !empty($id_meca) && !empty($datum) && !empty($vreme)) {
