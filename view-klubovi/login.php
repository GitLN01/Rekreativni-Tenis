                        ...
                        <div class="card-body p-5   " > 
                            ...
                            <form id="formLogin" action="../controller-klubovi/Login.php?action=login" method="post">
                                <div class="form-outline mb-4">
                                    ...
                                    <input type="text" id="korisnickoime" name="email" value="<?= $korisnicko_ime ?>" class="form-control form-control-lg" style="border-radius: 1rem; background-color: rgba(255, 255, 255, 0.5);"/>
                                ...
                                <div class="text-center">
                                    <input class="btn btn-primary btn-lg btn-block px-4 mt-3" type="submit" value="Prijava" name="prijavi" style="border-radius: 1rem; background-color: rgba(0, 0, 255, 0.5);">
