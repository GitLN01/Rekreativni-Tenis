    ...
    if (!isset($_SESSION['loginK'])) {
        ...
        <div class="container"
            ...
            <div class="row mt-4" style="width: 45%;margin-left:auto;margin-right:auto">
                <div class="col-md-12">
                    <form id="formIgrac" action="../controller-klubovi/Igraci.php?action=update" method="post"
                            ...
                            <div class="row">
                                <div class="col-md-6">
                                    ...
                                    <input type="text" class="form-control" id="" name="ime"
                                        value="<?= isset($igrac['ime']) ? $igrac['ime'] : '' ?>">
                                </div>
                                <div class="col-md-6">
                                    ...
                                    <input type="text" class="form-control" id="" name="prezime"
                                        value="<?= isset($igrac['prezime']) ? $igrac['prezime'] : '' ?>">
                                </div>
                            </div>
                            ...
                            <div class="row">
                                ...
                                <div class="col-md-4">
                                    ...
                                    <input type="number" class="form-control" id="" name="visina"
                                        value="<?= isset($igrac['visina']) ? $igrac['visina'] : '' ?>">
                                </div>
                                <div class="col-md-4">
                            ...
                            <div class="row">
                                <div class="col-md-6">
                                    ...
                                    <input type="number" class="form-control" id="" name="pobeda"
                                        value="<?= isset($igrac['pobeda']) ? $igrac['pobeda'] : '' ?>">
                                </div>
                                <div class="col-md-6">
                                    ...
                                    <input type="number" class="form-control" id="" name="porazi"
                                        value="<?= isset($igrac['porazi']) ? $igrac['porazi'] : '' ?>">
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="mb-3">
                            ...
                            <input type="email" class="form-control" id="" name="email"
                                value="<?= isset($igrac['email']) ? $igrac['email'] : "" ?>">
                        </div>
                        <div class="mb-3">
