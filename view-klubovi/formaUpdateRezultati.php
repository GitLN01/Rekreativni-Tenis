                ...
                <div class="col-md-12">
                    <form id="formRezultat" action="../controller-klubovi/controllerRezultat.php?action=update" method="post"
                        ...
                        <div class="mb-3">
                            ...
                            <input type="text" class="form-control" id="" name="rezultat"
                                value="<?= isset($rezultat['rezultat']) ? $rezultat['rezultat'] : '' ?>">
                        </div>
                        ...
                        <div class="mb-3 form-check">
                            ...
                            <select name="id_rezervacije" class="form-control">
                                ...
                                <?php foreach ($rezervacije as $item): ?>
                                    <option value=" <?= $item['id_r'] ?>">
                                        <?php echo 'Id: ' . $item['id_r'] . '   Datum:  ' . $item['datum'] . '   Vreme:  ' . $item['vreme'] ?>
                                    </option>
                                <?php endforeach ?>
                            </select>
                        </div>
