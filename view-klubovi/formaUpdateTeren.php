  ...
  if (!isset($_SESSION['loginK'])) {
    ...
    <div class="container" style="background-image: url('images/carousel1.jpg'); background-repeat: no-repeat; background-size: cover; ">
      <div class="row mt-4" style="width: 40%; margin-left: auto; margin-right: auto;">
        <div class="col-md-12">
          <form id="formTeren" action="../controller-klubovi/controllerTeren.php?action=update" method="post"
            ...
            <div class="mb-3">
              ...
              <input type="text" class="form-control" id="" name="naziv"
                value="<?= isset($teren['naziv']) ? $teren['naziv'] : '' ?>">

            </div>
            <div class="mb-3">
              <label for="lokacija" class="form-label">Lokacija <span class="text-danger">*</span></label>
              <input type="text" class="form-control" id="" name="lokacija"
                value="<?= isset($teren['lokacija']) ? $teren['lokacija'] : '' ?>">
            </div>

            <div class="mb-3">
              <label for="kapacitet" class="form-label">Kapacitet <span class="text-danger">*</span></label>
              <input type="text" class="form-control" id="" name="kapacitet"
                value="<?= isset($teren['kapacitet']) ? $teren['kapacitet'] : '' ?>">
            </div>
            <div class="mb-3">
              <label for="vrsta_podloge" class="form-label">Vrsta podloge <span class="text-danger">*</span></label>
              <input type="text" class="form-control" id="" name="vrsta_podloge"
                value="<?= isset($teren['vrsta_podloge']) ? $teren['vrsta_podloge'] : "" ?>">
            </div>
            ...
            <div class="mb-3">
              ...
              <select name="id_kluba" class="form-control">
                ...
                <option value="<?= $item['id'] ?>" <?= isset($teren['id_kluba']) && $teren['id_kluba'] == $item['id'] ? 'selected' : '' ?>><?= $item['naziv']; ?></option>
                <?php endforeach ?>
              </select>
